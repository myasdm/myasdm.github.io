      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        >
          <div className="flex items-center gap-2 text-muted-foreground text-sm font-mono">
            <span className={`inline-block w-2 h-2 rounded-full ${loadingComplete ? 'bg-primary' : 'bg-muted-foreground'} ${!shouldReduceAnimations && loadingComplete ? 'animate-pulse' : ''}`} />
        ...
        >
          <span 
            ...
            style={{
              textShadow: glitchActive && !shouldReduceAnimations
